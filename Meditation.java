...
class Meditation {
  ...
  public String getTotal() {
    //basically just convert seconds to seconds and minutes
    String str = "";
    if((seconds%60)<10)
    {
    ...
    // take away seconds from difference in minutes later
...
"When we fall, we get hurt - Brandon",
